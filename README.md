...
This GitHub-repository will walk you through how to use Jupyter Notebooks for data science projects [including AI data products] and how to set it up on your local machine.
